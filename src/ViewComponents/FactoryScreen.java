...
public class FactoryScreen extends ViewComponent{
	...
	public FactoryScreen(ResourceManager resourceManager, ModelMap map, RobotCreationButton creationButton, int xx, int yy) {
